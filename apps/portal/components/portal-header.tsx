    ...
    <header className="portal-header">
      ...
      <div className="portal-account">
        <nav className="portal-nav" aria-label={copy.shell.portal}>
          ...
          <Link href={localizeHref(locale, '/search')}>{copy.shell.search}</Link>
          <Link href={localizeHref(locale, '/notifications')}>
            {copy.shell.notifications}
          </Link>
          <Link href={localizeHref(locale, '/finance')}>{copy.shell.billing}</Link>
          <Link href={localizeHref(locale, '/account')}>{copy.shell.account}</Link>
        </nav>
