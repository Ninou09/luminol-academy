export const schools = {
  psychology: {
    ...
    promise: 'تفكير علمي، إنصات إنساني وأدوات عملية تُقدَّم بمسؤولية ووضوح.',
  ...
  languages: {
    ...
    programs: [
      ...
      },
      {
        ...
        description: 'تطوير متوازن للقواعد، الفهم، النطق والقدرة على التعبير.',
      },
      {
    ...
    approach: [
      ...
      },
      {
        ...
        description: 'نبني الثقة والمرونة للتواصل داخل القسم وخارجه.',
      },
    ],
