...
export const premiumVideos = {
  hero: {
    ...
    description:
      'مشهد تحريري يعبّر عن الشرح والمشاركة والأسئلة داخل بيئة تعلم إنسانية.',
    credit: 'Andy Barbour / Pexels',
    creditUrl:
  ...
  languages: {
    ...
    description:
      'مشهد تعليمي تحريري يركّز على الحوار، التفاعل والثقة في المشاركة.',
    credit: 'Andy Barbour / Pexels',
    creditUrl:
      'https://www.pexels.com/video/video-of-a-teacher-teaching-students-6671805/',
  ...
  training: {
    ...
    description:
      'مشهد تحريري لمحادثة مهنية يعبّر عن الحضور، التواصل وصياغة الأفكار بوضوح.',
