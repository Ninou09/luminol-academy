      ...
      fields: [
        defineField({
          ...
          fields: [
            ...
            defineField({
              name: 'body',
              title: 'French programme details',
              type: 'array',
              of: [{ type: 'block' }],
            }),
            defineField({
              name: 'outcomes',
              title: 'French learning outcomes',
              type: 'array',
              of: [{ type: 'string' }],
            ...
            defineField({
              name: 'audience',
              title: 'French intended audience',
              type: 'array',
              of: [{ type: 'string' }],
              validation: (rule) => rule.max(12),
            }),
        ...
        defineField({
          ...
          fields: [
            ...
            defineField({
              name: 'body',
              title: 'English programme details',
              type: 'array',
              of: [{ type: 'block' }],
            }),
            defineField({
              name: 'outcomes',
              title: 'English learning outcomes',
              type: 'array',
              of: [{ type: 'string' }],
              validation: (rule) => rule.max(12),
            }),
            defineField({
              name: 'audience',
              title: 'English intended audience',
              type: 'array',
              of: [{ type: 'string' }],
              validation: (rule) => rule.max(12),
            }),
