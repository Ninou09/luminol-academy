...
- Public editorial media must preserve its source, review state, alt text, and crop intent; use governed branch fallbacks instead of unreviewed or fabricated imagery.
