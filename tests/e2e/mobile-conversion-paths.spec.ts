...
test('Arabic consultation conversion stays usable at 320px', async ({ page }) => {
...
test('Arabic programme enquiry handoff stays usable at 320px', async ({ page }) => {
  await page.setViewportSize({ width: 320, height: 812 });
  ...
  if ((await card.count()) === 0) {
    ...
    await expect(page.locator('[data-contact-form] form.enquiry-form')).toBeVisible();
  }
